...
public class MemoryPlotPanel extends JPanel {
    ...
    public MemoryPlotPanel(int maxAge, String title) {
        ...
        lineRenderer.setStroke(new BasicStroke(2F, BasicStroke.CAP_ROUND,
        ...
        JFreeChart chart = new JFreeChart(title, new Font("SansSerif", Font.PLAIN, 14),
                xyplot, true);
        chart.setBackgroundPaint(Color.white);

        ChartPanel panel = new ChartPanel(chart);
        panel.setBorder(createCompoundBorder(createEmptyBorder(8, 8, 8, 8),
